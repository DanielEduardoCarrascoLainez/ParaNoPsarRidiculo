...
//Este arraylist será para almacenar unas cositas de los pokémon pues se planea recopilar la info de todos los pokémon que se busquen para imprimirlos al finalizar el programa.
...
public class ProyectoFinal_DanielYCatalina {
    ...
    public static void main(String[] args) {
        ...
        //EALEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE
        System.out.println("Ingrese a que ejercicio ir 1, 2 o 3, 4 para salir");
        int ejer = ninetales.nextInt();
        boolean banderinga = true;
